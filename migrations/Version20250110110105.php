 ...
 */
final class Version20250110110105 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE job_offer (id INT AUTO_INCREMENT NOT NULL, title VARCHAR(255) NOT NULL, description LONGTEXT NOT NULL, created_at DATETIME NOT NULL, company_id INT NOT NULL, INDEX IDX_288A3A4E979B1AD6 (company_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4');
        ...
        $this->addSql('ALTER TABLE job_application CHANGE status status VARCHAR(255) NOT NULL, CHANGE cv_filename cv_filename VARCHAR(255) DEFAULT NULL, CHANGE updated_at updated_at DATETIME DEFAULT NULL, CHANGE feedback company_response LONGTEXT DEFAULT NULL, CHANGE job_post_id job_offer_id INT NOT NULL');
        ...
        $this->addSql('ALTER TABLE job_application ADD CONSTRAINT FK_C737C68864DD9267 FOREIGN KEY (developer_id) REFERENCES `user` (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE job_application CHANGE cv_filename cv_filename VARCHAR(255) DEFAULT \'NULL\', CHANGE status status VARCHAR(20) NOT NULL, CHANGE updated_at updated_at DATETIME DEFAULT \'NULL\', CHANGE job_offer_id job_post_id INT NOT NULL, CHANGE company_response feedback LONGTEXT DEFAULT NULL');
